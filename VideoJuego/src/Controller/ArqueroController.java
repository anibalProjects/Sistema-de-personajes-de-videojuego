...
public class ArqueroController {
    ...
    public void mostrarMenu() {
        ...
        System.out.println("VIDA: " + arquero.getSalud());
        ...
        switch (opcion) {
            case 1 -> {
                if (arquero.getNumFlechas() <= 0) {
                    ...
                    arquero.atacar();
                    contrario.recibirDanio(arquero.getDaño());
                    System.out.println(
                            arquero.getNombre() + " lanzó una flecha! Al enemigo le queda " + contrario.getSalud());
                }
